...
final class CommandExecutorMockTests: XCTestCase {
    ...
    private class TestableCommandExecutor {
    ...
    private class MockProcessWithPipe: Process, @unchecked Sendable {
    ...
    func testCommandPriorityBunxOverNpx() async throws {
        ...
        _ = "/Users/test/.local/share/mise/installs/bun/latest/bin/bunx"
        _ = "/usr/local/bin/npx"
