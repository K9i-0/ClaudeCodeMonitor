...
final class ModelsTests: XCTestCase {
    ...
    func testUsageDataBillableTokens() {
        ...
        XCTAssertEqual(usageData.todayBillableTokens, 1_000)
        ...
        XCTAssertEqual(usageData.monthlyBillableTokens, 50_000)
    }
    ...
    func testDailyUsageDecoding() throws {
        ...
        XCTAssertEqual(dailyUsage.totalTokens, 1_150)
    ...
    func testCcusageResponseDecoding() throws {
        ...
        XCTAssertEqual(response.totals.totalTokens, 50_000)
